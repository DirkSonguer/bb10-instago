...
var instagoLoginBody = "<html>You are not connected to Instagram, only the public features are available at the moment.<br /><br />Please connect to Instagram to use features like your news stream, following other users or liking other users photos.<br /><br />Note that you need an Instagram account to log in.</html>";
